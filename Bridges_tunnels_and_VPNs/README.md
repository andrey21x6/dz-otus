...
- можно пробрасывать VLAN-ы
- позволяет использовать динамическую маршрутизацию, например OSPF
- мультикаст тоже работает
...
- может использовать разные типы подклчений, site-to-site, client-to-client, server-to-client
- можно использовать iBGP для маршрутизации

**Недостатки**:
- broadcast-трафик обычно не передаётся
- нельзя использовать мосты
- не позволяет использовать динамическую маршрутизацию, например OSPF
